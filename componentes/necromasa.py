...
class Necromasa:
    ...
    Atributos:
        masas: {clave_material: cantidad_kg} -- ver config/materiales.yaml
            y nucleo/entidad.py:componer_necromasa. Un cadáver se reparte
            entre 'tejido_blando' (se descompone rápido, realimenta
            fertilidad) y 'hueso' (un orden de magnitud más lento,
            persiste como resto tangible tras la muerte en vez de

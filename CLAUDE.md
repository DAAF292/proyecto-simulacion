...
- **El criterio maestro de Diego (5 especies vivas a la vez, ≥50% de las
  ...
  ciegas.
- Recomendaciones del informe de calibración del 2026-09-12 sin
  implementar: densidad de venado para sostener a lobo, revisar a la
  baja `factor_ampliacion_techo_manada` (dirección de signo ya señalada
  como error a evitar), sesgo de vocación hacia forrajero casi en
  exclusiva, reputación de liderazgo (piezas 5a/5b) con 0 usos
  observados en la última corrida grande.
- **Caza en manada de lobo contra caballo**: mecanismo verificado
  ...
  rara — 0 casos en más de 70 corridas acumuladas de varias sesiones.
